...
# Input file path
input_file = "processed_urls.csv"  # Replace with your processed file
...
# Step 4: Train the LinearSVC model
print("[INFO] Training the LinearSVC model (this might take some time)...")
start_time = time.time()
model = LinearSVC(random_state=42, max_iter=5000)  # Increased iterations to ensure convergence
model.fit(X_train, y_train)
print(f"[INFO] LinearSVC model trained in {time.time() - start_time:.2f} seconds.")
